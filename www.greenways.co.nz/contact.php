...
<head>
  ...
  <script type="text/javascript" src="http://greenways-sandbox.tk/contact/contact-form.js"></script>
...
<body>
  <div class="wrapper">
    ...
    <div id="contentbody" style="float: left; margin-left: 10px;">
      <div id="img" style="position: relative; width: 512px; height: 206px; background: url('images/base/contentbox_tl.png'); float: left;">
      ...
      <div id="cform" style="position: relative; margin: 10px 0 0 0; width: 512px; height: 295px; background: url('images/base/cformbg.png'); float: left;">
...
<!--           <div style="float: left; height: 110px; width: 94px; margin-left: 20px; MARGIN-TOP: 22PX; COLOR: #fff; font-size: 21px;">
 ...
 -->
          <?php
            ...
            $contact_form_path = '/home/minha/greenways-sandbox/contact-files/'; // set path to /contact-files/ with slash on end.
